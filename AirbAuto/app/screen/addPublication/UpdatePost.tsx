...
const UpdatePost = (props: ExplorerType) => {
  ...
  useEffect(() => {
    setTitrePublication(publication.Titre_Publication);
    setDate(publication.Date_Immatriculation);
    setDescriptionPublication(publication.Description_Publication);
    setImage(publication.img_Publication1);
    setImage2(publication.img_Publication2);
    setImage3(publication.img_Publication3);
    setMarqueVehicule(publication.Marque_Vehicule);
    setKm(publication.kilometre);
    setSelectedCarburant(publication.Carburant);
    setDepartement(publication.Departement);
    setPrix(publication.Prix);
    setVille(publication.Ville);
  }, [publication]);
  ...
  const addPost = async () => {
    ...
    const data = JSON.stringify({
      ...
      ID_Type_Publication: publication.ID_Type_Publication,
...
export default connector(UpdatePost);
